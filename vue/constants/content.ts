...
const content = {
    [keysMap.GIT]: [
        {
            title: '🔖 Семантическое версионирование и соглашения коммитов',
            items: [
                {
                    title: 'SemVer – Семантическое версионирование',
                    text: `\`\`\`text
...
- ✘ При MAJOR-изменениях важно документировать, что сломалось`
                },
                {
                    title: 'Conventional Commits – Соглашения по названиям коммитов',
                    text: `\`\`\`text
...
- ✘ Нужны линтеры или хуки, чтобы все придерживались стиля`
                },
                {
                    title: 'Примеры коммитов',
                    text: `\`\`\`text
...
- ✘ Обращение к \`let/const\` до строки объявления вызывает ошибку`
        ...
        {
            title: '📌 Область видимости и всплытие (Hoisting)',
            items: [
                {
                    title: 'Global Scope – Глобальная область видимости',
                    text: `\`\`\`js
const user = 'Roman'
...
- ✘ Риск переопределения переменных в других скриптах`
                },
                {
                    title: 'Function Scope – Область функции',
                    text: `\`\`\`js
function greet() {
  const name = 'Roman'
  console.log(name)
...
- ✘ Не видно снаружи, даже если нужно`
                },
                {
                    title: 'Block Scope – Блочная область видимости (let, const)',
                    text: `\`\`\`js
if (true) {
  let count = 5
}
...
- ✘ var не поддерживает блоковую область`
                },
                {
                    title: 'Lexical Scope – Лексическая область',
                    text: `\`\`\`js
function outer() {
  const x = 10
  function inner() {
...
- ✘ Нет доступа к "внутренним" переменным снаружи`
                },
                {
...
- ✘ Может вызывать путаницу и баги`
                },
                {
...
- ✘ Возможна утечка памяти, если не очищать замыкания`
                }
            ]
        },
        {
